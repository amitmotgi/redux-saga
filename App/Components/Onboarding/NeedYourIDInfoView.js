...
class NeedYourIDInfoView extends Component {
          ...
          <View>
            <Image
              style={{
                ...
                height: DimensionManager.verticalScale(246),
                width: DimensionManager.scale(243),
                marginLeft: DimensionManager.scale(54),
                alignSelf: 'center',
                resizeMode: 'contain',
              }}
              source={require('../Images/need-your-id.png')} />
              ...
              <Text style={{
                ...
                We’re about to ask you for some personal information. We’re doing this as required by law.
              </Text>
...
export default connect(mapStateToProps, mapDispatchToProps)(withNavigation(NeedYourIDInfoView));

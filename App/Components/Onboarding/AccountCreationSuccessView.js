...
class AccountCreationSuccessView extends Component {
          ...
          <View>
            <Image
              ...
              <Text style={{
                ...
                You just completed setting up your account. Let’s move forward in verifying your Mobile Number.
              </Text>
...
export default connect(mapStateToProps, mapDispatchToProps)(withNavigation(AccountCreationSuccessView));

...
class ApplicationInReviewView extends Component {
        ...
        <HeaderBarOnboardingView
          ...
          <View>
            <Image
              ...
              source={require('../Images/exclaimation.png')} />
              ...
              <Text style={{
                ...
                We are in the process of reviewing your application. Our loan representitive will contact you within the next 24 hours.
              </Text>
...
export default connect(mapStateToProps, mapDispatchToProps)(withNavigation(ApplicationInReviewView));
